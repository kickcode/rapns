...
describe Rapns::Notification do
  it "should validate presence of the device_token" do
    notification = Rapns::Notification.new(:device_token => nil)
    notification.valid?.should be_false
    notification.errors[:device_token].include?("can't be blank").should be_true
  end
...
describe Rapns::Notification, "to_binary" do
  it "should correctly convert the notification to binary" do
    ...
    notification.to_binary.should == "\x01\x02\xF3c\x80\x00\x01Q\x80\x00 \xAA\xAA\xAA\xAA\xAA\xAA\xAA\xAA\xAA\xAA\xAA\xAA\xAA\xAA\xAA\xAA\xAA\xAA\xAA\xAA\xAA\xAA\xAA\xAA\xAA\xAA\xAA\xAA\xAA\xAA\xAA\xAA\x00a{\"aps\":{\"alert\":\"Don't panic Mr Mainwaring, don't panic!\",\"badge\":3,\"sound\":\"1.aiff\"},\"hi\":\"mom\"}"
  end
end
